...
class VGSFieldStateTest {
    ...
    fun isValidRequiredTrueCall() {
        val type = Mockito.mock(VGSEditTextFieldType::class.java)
    ...
    fun map_VGSTextInputTypeTo_CardNumberState() {
        val cn = VGSEditTextFieldType.CardNumber()
    ...
    fun map_VGSTextInputTypeTo_CardExpirationDate() {
        val ce = VGSEditTextFieldType.CardExpDate
    ...
    fun map_VGSTextInputTypeTo_CardName() {
        val co = VGSEditTextFieldType.CardHolderName
    ...
    fun map_VGSTextInputTypeTo_CVCCardCode() {
        val cv = VGSEditTextFieldType.CVCCardCode
