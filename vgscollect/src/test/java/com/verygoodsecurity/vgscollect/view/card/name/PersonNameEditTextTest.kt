...
class PersonNameEditTextTest {
    ...
    fun test_storage_type() {
        ...
        val child = view.statePreparer.getView()
        assertEquals((child as PersonNameInputField).vaultStorage, VGSVaultStorageType.VOLATILE)
    }
    ...
    fun test_enabled_tokenization() {
        ...
        val child = view.statePreparer.getView()
        assertEquals((child as PersonNameInputField).isEnabledTokenization, false)
    }

    @Test
    fun test_default_tokenization_settings() {
        val child = view.statePreparer.getView()
        assertEquals((child as PersonNameInputField).isEnabledTokenization, true)
